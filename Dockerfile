...
ENV RAILS_ENV=production \
  ...
  RUBY_GC_HEAP_INIT_SLOTS=3000 \
  RUBY_GC_HEAP_FREE_SLOTS=1000 \
  RUBY_GC_HEAP_GROWTH_FACTOR=1.05 \
  RUBY_GC_HEAP_GROWTH_MAX_SLOTS=2000 \
  RUBY_GC_HEAP_OLDOBJECT_LIMIT_FACTOR=1.1 \
  RUBY_GC_MALLOC_LIMIT=1048576 \
  RUBY_GC_MALLOC_LIMIT_MAX=4194304 \
  RUBY_GC_MALLOC_LIMIT_GROWTH_FACTOR=1.05 \
  RUBY_GC_OLDMALLOC_LIMIT=1048576 \
  RUBY_GC_OLDMALLOC_LIMIT_MAX=4194304 \
  RUBY_GC_OLDMALLOC_LIMIT_GROWTH_FACTOR=1.05
