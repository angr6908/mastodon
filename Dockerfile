...
ENV RAILS_ENV=production \
  ...
  MALLOC_CONF=narenas:1,background_thread:true,thp:never,dirty_decay_ms:1000,muzzy_decay_ms:0 \
  RUBY_GC_HEAP_INIT_SLOTS=5000 \
  RUBY_GC_HEAP_FREE_SLOTS=2048 \
  RUBY_GC_HEAP_GROWTH_FACTOR=1.1 \
  RUBY_GC_HEAP_GROWTH_MAX_SLOTS=5000 \
  RUBY_GC_HEAP_OLDOBJECT_LIMIT_FACTOR=1.2 \
  RUBY_GC_MALLOC_LIMIT=2097152 \
  RUBY_GC_MALLOC_LIMIT_MAX=8388608 \
  RUBY_GC_MALLOC_LIMIT_GROWTH_FACTOR=1.1 \
  RUBY_GC_OLDMALLOC_LIMIT=2097152 \
  RUBY_GC_OLDMALLOC_LIMIT_MAX=8388608 \
